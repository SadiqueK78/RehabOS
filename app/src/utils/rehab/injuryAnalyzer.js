...
const injuryKeywordMap = {
  ...
  "shoulder pain": ["armRaise", "sideArmRaise", "shoulderRolls", "lateralExternalRotation"],
  "shoulder stiffness": ["armRaise", "shoulderRolls", "lateralExternalRotation"],
  "shoulder impingement": ["lateralExternalRotation", "shoulderRolls"],
  "rotator cuff": ["lateralExternalRotation", "shoulderRolls"],
  "frozen shoulder": ["armRaise", "sideArmRaise", "shoulderRolls", "lateralExternalRotation"],
  "shoulder injury": ["armRaise", "sideArmRaise", "shoulderRolls", "lateralExternalRotation"],
  ...
  // Knee & Leg
  "knee pain": ["heelSlide", "straightLegRaise", "miniSquat", "seatedKneeExtension"],
  "knee injury": ["heelSlide", "straightLegRaise", "seatedKneeExtension", "miniSquat"],
  "acl": ["heelSlide", "straightLegRaise", "miniSquat", "bridge"],
  "mcl": ["legRaise", "squat"],
  "meniscus": ["legRaise", "squat"],
  "patella": ["legRaise", "squat"],
  "knee replacement": ["anklePumps", "heelSlide", "straightLegRaise", "seatedKneeExtension", "sitToStand"],
  "knee stiffness": ["heelSlide", "seatedKneeExtension", "miniSquat"],
  "leg weakness": ["sitToStand", "seatedMarching", "miniSquat", "straightLegRaise"],
  "leg pain": ["legRaise", "squat", "lunge"],
  "hip pain": ["hipAbduction", "bridge", "seatedMarching"],
  "hip replacement": ["anklePumps", "heelSlide", "hipAbduction", "sitToStand"],
  "hip flexor": ["legRaise", "deadBug", "lunge"],
  "ankle": ["anklePumps", "calfRaise", "singleLegBalance"],
  "calf": ["squat", "lunge"],
  ...
  "post surgery": ["anklePumps", "heelSlide", "straightLegRaise", "armRaise"],
  "post operative": ["anklePumps", "heelSlide", "straightLegRaise"],
  ...
  // Elderly, neurological & limited-mobility rehab
  "elderly": ["sitToStand", "seatedMarching", "singleLegBalance", "armRaise"],
  "senior": ["sitToStand", "seatedMarching", "singleLegBalance", "armRaise"],
  "old age": ["sitToStand", "seatedMarching", "singleLegBalance"],
  "fall": ["singleLegBalance", "sitToStand", "hipAbduction", "calfRaise"],
  "unsteady": ["singleLegBalance", "sitToStand", "hipAbduction"],
  "dizziness": ["seatedMarching", "sitToStand"],
  "stroke": ["seatedMarching", "sitToStand", "armRaise", "heelSlide"],
  "hemiplegia": ["armRaise", "seatedMarching", "heelSlide"],
  "paralysis": ["anklePumps", "heelSlide", "armRaise"],
  "parkinson": ["sitToStand", "seatedMarching", "singleLegBalance", "armRaise"],
  "arthritis": ["heelSlide", "seatedKneeExtension", "armRaise", "anklePumps"],
  "osteoarthritis": ["heelSlide", "straightLegRaise", "seatedKneeExtension", "miniSquat"],
  "rheumatoid": ["armRaise", "anklePumps", "heelSlide"],
  "osteoporosis": ["singleLegBalance", "sitToStand", "wallPushUp"],
  "bed rest": ["anklePumps", "heelSlide", "straightLegRaise"],
  "bedridden": ["anklePumps", "heelSlide", "armRaise"],
  "wheelchair": ["seatedMarching", "armRaise", "sideArmRaise", "anklePumps"],
  "limited mobility": ["seatedMarching", "anklePumps", "armRaise", "heelSlide"],
  "fracture": ["anklePumps", "heelSlide", "armRaise"],
  "ankle sprain": ["anklePumps", "calfRaise", "singleLegBalance"],
  "blood clot": ["anklePumps"],
  "circulation": ["anklePumps", "seatedMarching"],
  "swelling": ["anklePumps", "heelSlide"],
  "walking": ["sitToStand", "hipAbduction", "singleLegBalance", "seatedMarching"],
  "getting up": ["sitToStand"],
  "weak legs": ["sitToStand", "seatedMarching", "miniSquat"],
  // Muscle groups
...
const exercisePlanDefaults = {
  ...
  heelSlide:               { reps: 10, sets: 2, holdSeconds: 0 , frequencyPerWeek: 7, difficulty: "beginner",     muscleGroup: "Knee Mobility" },
  anklePumps:              { reps: 20, sets: 2, holdSeconds: 0 , frequencyPerWeek: 7, difficulty: "beginner",     muscleGroup: "Ankle & Circulation" },
  straightLegRaise:        { reps: 10, sets: 2, holdSeconds: 2 , frequencyPerWeek: 5, difficulty: "beginner",     muscleGroup: "Quadriceps" },
  sitToStand:              { reps: 8 , sets: 2, holdSeconds: 0 , frequencyPerWeek: 5, difficulty: "beginner",     muscleGroup: "Legs & Independence" },
  seatedMarching:          { reps: 12, sets: 2, holdSeconds: 0 , frequencyPerWeek: 6, difficulty: "beginner",     muscleGroup: "Hips & Balance" },
  armRaise:                { reps: 10, sets: 2, holdSeconds: 0 , frequencyPerWeek: 6, difficulty: "beginner",     muscleGroup: "Shoulder Mobility" },
  sideArmRaise:            { reps: 10, sets: 2, holdSeconds: 0 , frequencyPerWeek: 5, difficulty: "beginner",     muscleGroup: "Shoulder Strength" },
  wallPushUp:              { reps: 10, sets: 2, holdSeconds: 0 , frequencyPerWeek: 4, difficulty: "beginner",     muscleGroup: "Arms & Chest" },
  hipAbduction:            { reps: 10, sets: 2, holdSeconds: 0 , frequencyPerWeek: 5, difficulty: "beginner",     muscleGroup: "Outer Hip" },
  singleLegBalance:        { reps: 3 , sets: 2, holdSeconds: 8 , frequencyPerWeek: 6, difficulty: "beginner",     muscleGroup: "Balance" },
  miniSquat:               { reps: 10, sets: 2, holdSeconds: 0 , frequencyPerWeek: 5, difficulty: "beginner",     muscleGroup: "Legs & Knees" },
  seatedKneeExtension:     { reps: 10, sets: 2, holdSeconds: 3 , frequencyPerWeek: 6, difficulty: "beginner",     muscleGroup: "Quadriceps" },
  calfRaise:               { reps: 12, sets: 2, holdSeconds: 0 , frequencyPerWeek: 5, difficulty: "beginner",     muscleGroup: "Calves & Ankles" },
  neckTilt:                { reps: 5 , sets: 2, holdSeconds: 10, frequencyPerWeek: 7, difficulty: "beginner",     muscleGroup: "Neck Mobility" },
};
